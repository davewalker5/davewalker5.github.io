---
layout: journal
title: "The Hadzabe Tribe and Onwards to Ngorongoro"
breadcrumb: "The Hadzabe"
date: 2022-06-24
categories: ["travel", "tanzania", "field-notes"]
tags: ["lake eyasi", "kisima ngeda", "hadzabe", "ngorongoro", "safari", "travel-journal", "wildlife-travel"]
...
baobab:
  - name: "07-baobab.jpg"
    alt: "A photograph taken together during our visit with the Hadzabe, in the bush near Lake Eyasi"
    caption: "A photograph taken together during our visit with the Hadzabe, in the bush near Lake Eyasi"
    credit: "David Walker, Field Notes Journal"
    license: "All rights reserved — not licensed for reuse"
images:
notes:
  - title: "Hadzabe"
    text: "hunter-gatherer people of northern Tanzania; known for use of click-based language and traditional hunting practices"
  - title: "Hunting Demonstration"
    text: "use of role-play to explain hunting techniques and prey behaviour; communication through gesture and sound"
  - title: "Arrowheads"
    text: "iron points (often obtained through trade) used for medium to large prey; barbed design allows application of plant-based poison"
  - title: "Poison Use"
    text: "plant-derived toxins applied to arrowheads; enter bloodstream on impact and act systemically"
  - title: "Foraging"
    text: "berries gathered and consumed in situ; opportunistic hunting of small birds using bow and arrow"
  - title: "Baobab Tree (<em>Adansonia</em>)"
    text: "large, long-lived tree characteristic of the region; observed as focal point during foraging activity"
  - title: "Cultural Exchange"
    text: "interaction structured as demonstration and shared experience; guided interpretation between groups"
  - title: "Ngorongoro Crater"
    text: "collapsed volcanic caldera; high-altitude rim (~2300 m) overlooking enclosed ecosystem below"
---
...
From the Hadzabe, we drove back along the same dusty, terracotta-coloured roads we travelled along the day before, refuelling at Karatu and taking an interesting trip into its back-streets to a panel beaters to have some spot welding done to fix some minor damage to the Land Cruiser!
...
{% include image-block.html images=page.baobab assets=assets_url %}
