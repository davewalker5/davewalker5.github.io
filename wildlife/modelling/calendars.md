...
<div class="blog-image-grid blog-image-grid--1-col">
  <figure>
    <img src="{{ site.assets_url }}/images/modelling/interpretive-workflow.png" alt="Seasonal Neighbourhood Analysis Workflow">
    <figcaption>Seasonal Neighbourhood Analysis Workflow</figcaption>
  </figure>
</div>
...
<div class="blog-image-grid blog-image-grid--1-col">
  <figure>
    <img src="{{ site.assets_url }}/images/modelling/abingdon/yil/cluster-activity-heatmap.png" alt="Cluster Seasonal Activity Heatmap">
