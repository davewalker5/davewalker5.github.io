...
EXCLUDE_SERIES = [
    ...
    "Photomicrography Feasibility",
    "OBS Studio Feasibility"
]
...
def copy_plate_images(plate_names, input_dir, output_dir):
    ...
    for plate_name in sorted(plate_names):
        ...
        source = matches[0]
        destination = output_dir / plate_name

        # Skip copying if the file already exists in the destination
