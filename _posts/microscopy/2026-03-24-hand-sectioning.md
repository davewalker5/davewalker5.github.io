---
layout: post
title: "Improved Improvised Sectioning: Galium aparine and Taraxacum officinale Revisited"
date: 2026-03-24
categories: [microscopy]
tags: [methods]
excerpt: "Revisiting Galium aparine and Taraxacum officinale stem sections using an improved version of the improvised double-bladed sectioning tool"
---
...
In the initial experiment, sections were produced using the first iteration of the tool, a double-bladed design described on the Microscopy UK site - ["How to make thin slices of specimens. And mount them."](https://www.microscopy-uk.org.uk/mag/artoct20/ms-hand-sectioning-plants.pdf). The design placed the two cutting edges next to one another.
...
<div class="blog-image-grid blog-image-grid--1-col">
  <figure>
    <img id="plate-img" class="responsive" alt="Photomicrographic Plate SI-II-027" src="{{ site.assets_url }}/plates/preview/SI-II-027.png">
