...
<figure class="report-figure no-print">
  <div id="video-wrap" class="report-image-wrap">
    <audio id="recording-audio" controls preload="metadata" style="width:100%;">
      <source id="audio-source" src="{{ site.assets_url }}/recordings/blog/echoes_of_the_past_001.wav" type="audio/wav" />
...
<div class="blog-image-grid blog-image-grid--1-col">
  <figure>
    <img src="{{ site.assets_url }}/images/blog/echoes_of_the_past_001.png" alt="Pipistrelle Search and Feeding Buzz">
