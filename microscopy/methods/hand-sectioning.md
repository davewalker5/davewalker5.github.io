---
layout: default
title: Hand Sectioning of Plant Material (Improvised Sectioning Tool)
breadcrumb: Hand Sectioning
description: Hand Sectioning of Plant Material (Improvised Sectioning Tool)
breadcrumb_items:
  - name: Home
    url: /
  - name: Microscopy
    url: /microscopy/
  - name: Hand Sectioning
    url: /microscopy/methods/hand-sectioning.html
---
...
- ["How to make thin slices of specimens. And mount them." – Microscopy UK](http://www.microscopy-uk.org.uk/mag/artoct20/ms-hand-sectioning-plants.pdf)
...
<div class="image-grid image-grid--3-col">

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-01.jpg" alt="Step 1">
    <figcaption>Step 1</figcaption>
  </figure>

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-02.jpg" alt="Step 2">
    <figcaption>Step 2</figcaption>
  </figure>

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-03.jpg" alt="Step 3">
    <figcaption>Step 3</figcaption>
  </figure>

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-04.jpg" alt="Step 4">
    <figcaption>Step 4</figcaption>
  </figure>

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-05.jpg" alt="Step 5">
    <figcaption>Step 5</figcaption>
  </figure>

  <figure>
    <img src="{{ site.assets_url }}/images/sectioning/tool-06.jpg" alt="Step 6">
    <figcaption>Step 6</figcaption>
  </figure>

</div>

1. A length of electrical or similar tape is cut to be just a little shorter than the width of the blade
2. The first blade is placed carefully along the bottom edge of the tape, making sure the cutting edge isn't obscured
3. A small slip of printer paper is laid carefully over the blade, makgin sure it will act as a separator but not interfere with the cutting edges or prevent cut sections passing into the gap between the blades
4. The second blade is placed over the first, taking care to align the two as completely as possible
5. The tape is carefully folded over and pressed onto the upper surface of the second blade, forming a "hinge" between the two blades
6. Two small bulldog clips are used to clip the two blades togeter to maintain rigidity and prevent the blades from slipping during cutting
...
- The specimen (e.g. stem) is held firmly, in my case in a small amount of water on a glass slide
